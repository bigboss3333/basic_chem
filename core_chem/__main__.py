...
from core_chem.conversions import (
...
def main():
    ...
    print(
        calculate_percent_composition_elemental(
            number_of_moles, element_id, compound_id
        )
    )
    ...
    print(
        calculate_boyles_law(
            pressure_one=100.000, volume_one=80.02, pressure_two=None, volume_two=20.1
        )
    )
