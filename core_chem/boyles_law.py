def calculate_boyles_law(pressure_one=None, volume_one=None, pressure_two=None, volume_two=None) -> float:
    ...
    """
    if sum(i is not None for i in [pressure_one,
                                   volume_one,
                                   pressure_two,
                                   volume_two]) == 1:
    ...
    if pressure_one is None:
        result = (
                (pressure_two * volume_two) / volume_one
        )
    elif volume_one is None:
        result = (
                (pressure_two * volume_two) / pressure_one
        )
    elif pressure_two is None:
        result = (
                (pressure_one * volume_one) / volume_two
        )
    elif volume_two is None:
        result = (
                (pressure_one * volume_one) / pressure_two
        )
    else:
